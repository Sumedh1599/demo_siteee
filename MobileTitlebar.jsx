  ...
  return (
    <>
      <div className="mobile-titlebar">
        ...
        <button className="early-access-btn" onClick={() => handleMobileNavClick('demo')}>
          Demo
        </button>
      </div>
        ...
        <div className="mobile-menu-overlay" onClick={handleMobileMenuToggle}>
          <div className="mobile-menu" onClick={(e) => e.stopPropagation()}>
            <div className="mobile-menu-header">
              ...
              <button className="close-menu" onClick={handleMobileMenuToggle}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mobile-menu-items">
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('home')}>
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('demo')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('aiChat')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('brainstorm')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('codeNow')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('courseDesigner')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('deepResearch')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('videoSummarizer')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button className="mobile-menu-item" onClick={() => handleMobileNavClick('myNotes')}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
